...
CHANGED: 2013-04-01 - added in CMP only fields
    ethnicity - but as white
    loca and ploca - only 6% come via another intermediate care area: not worth it
    cpr - purposefully excluded
    height/weight - bmi - not in this view of the data: leave
...
*  =========================
GenericSetupSteveHarris spot_traj an_tables_traj_pt_chars, logon
global table_name traj_pt_chars
...
local sparkhbar_vars ///
    sex v_ccmds vitals  delayed_referral sepsis rx_visit rxlimits  ///
        ccmds_delta v_decision icu_delay dead_icu dead28 dead90 white
