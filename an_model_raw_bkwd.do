...
foreach pvar of local physiology_vars {
	...
	*/
	...
	graph export ../outputs/figures/bkwd_`pvar'_grid_m0.pdf ///
	...
	graph export ../outputs/figures/bkwd_`pvar'_grid_mi.pdf ///
	    , name(bkwd_`pvar'_grid_mi) replace

	graph combine bkwd_`pvar'_grid_m0 bkwd_`pvar'_grid_mi, ///
		rows(1) name(bkwd_`pvar'_grid, replace) ///
		xsize(6) ysize(4)
